...
def home():
	...
	addDir('[COLOR white][B]Android APK[/COLOR][/B]','url',4000,icon,fanart,'')
	addDir('[COLOR white][B]windows API[/COLOR][/B]','url',5000,icon,fanart,'')	
...
def popupd(announce):
	...
	class TextBox():
		...
		def setControls(self):
			self.win.getControl(self.CONTROL_LABEL).setLabel('live TV Online') # set heading
