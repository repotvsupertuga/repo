...
class sources:
    ...
    def getConstants(self):
        self.itemProperty = 'script.module.stream.tvsupertuga.addon.container.items'

        self.metaProperty = 'script.module.stream.tvsupertuga.addon.container.meta'
